...
export const formProject = {
  ...
  badge: 'new',
  bgStyle: 'bg-yellow-500/40 dark:bg-yellow-500/30',
  bgStyleAccent: 'bg-yellow-500',
  bgStyleAccentHover: 'hover:bg-yellow-500/30 dark:hover:bg-yellow-500/40',
  bgStyleMuted: 'bg-yellow-500/20',
