...
export const queryProject = {
  ...
  badge: undefined,
  bgStyle: 'bg-red-500/40 dark:bg-red-500/30',
  bgStyleAccent: 'bg-red-500',
  bgStyleAccentHover: 'hover:bg-red-500/30 dark:hover:bg-red-500/40',
  bgStyleMuted: 'bg-red-500/20',
