...
export const tableProject = {
  ...
  badge: undefined,
  bgStyle: 'bg-blue-500/40 dark:bg-blue-500/30',
  bgStyleAccent: 'bg-blue-500',
  bgStyleAccentHover: 'hover:bg-blue-500/30 dark:hover:bg-blue-500/40',
  bgStyleMuted: 'bg-blue-500/20',
