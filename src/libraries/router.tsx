...
export const routerProject = {
  ...
  bgStyle: 'bg-emerald-500/40 dark:bg-emerald-500/30',
  bgStyleAccent: 'bg-emerald-500',
  bgStyleAccentHover: 'hover:bg-emerald-500/30 dark:hover:bg-emerald-500/40',
  bgStyleMuted: 'bg-emerald-500/20',
