...
export const configProject = {
  ...
  badge: undefined,
  bgStyleAccent: 'bg-slate-500',
  bgStyleAccentHover: 'hover:bg-slate-500/30 dark:hover:bg-slate-500/40',
  bgStyle: 'bg-slate-500/40 dark:bg-slate-500/30',
  bgStyleMuted: 'bg-slate-500/20',
