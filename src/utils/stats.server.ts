...
import { fetchGitHubRepoStats } from './stats.functions'
import {
...
function hasAnyOSSStats(
  ...
  return (
    !!stats &&
    (stats.npm.totalDownloads > 0 ||
      stats.github.starCount > 0 ||
      stats.github.contributorCount > 0 ||
      (stats.github.dependentCount ?? 0) > 0)
  )
}
