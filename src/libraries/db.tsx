...
export const dbProject = {
  ...
  badge: 'beta',
  bgStyle: `bg-orange-700/40 dark:bg-orange-700/30`,
  bgStyleMuted: `bg-orange-700/20 dark:bg-orange-700/30`,
  bgStyleAccent: `bg-orange-700`,
  bgStyleAccentHover: `hover:bg-orange-700/30 dark:hover:bg-orange-700/40`,
