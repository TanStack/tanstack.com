 ...
 *
 * Scheduled: Runs automatically every 10 seconds (configured via export config)
 */
 ...
 * - schedule: Cron expression for scheduled execution (runs every 10 seconds)
 */
export const config = {
  type: "experimental-scheduled" as const,
  schedule: "*/10 * * * * *", // Every 10 seconds (6-field cron with seconds)
};
