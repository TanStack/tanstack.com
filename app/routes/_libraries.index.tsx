  ...
  return (
    <>
      ...
      <div className="max-w-full z-10">
        ...
        <div className="h-8" />
        <div className="p-8 w-fit mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 items-center justify-center place-items-center bg-white/50 rounded-xl shadow-xl">
