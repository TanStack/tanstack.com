...
import { optimisticProject } from '~/libraries/optimistic'
...
export const Route = createFileRoute('/_libraries/optimistic/$version/')({
  component: OptimisticVersionIndex,
  head: () => ({
    meta: seo({
      title: optimisticProject.name,
...
const library = getLibrary('optimistic')

export default function OptimisticVersionIndex() {
  const { sponsorsPromise } = librariesRouteApi.useLoaderData()
  const { version } = Route.useParams()

  const gradientText = `pr-1 inline-block text-transparent bg-clip-text bg-gradient-to-r ${optimisticProject.colorFrom} ${optimisticProject.colorTo}`
      ...
      <div className="flex flex-col gap-20 md:gap-32 max-w-full pt-32">
        <div className="flex flex-col items-center gap-6 text-center px-4">
          <h1 className="font-black flex gap-3 items-center text-4xl md:text-6xl lg:text-7xl xl:text-8xl uppercase [letter-spacing:-.05em]">
            <span>TanStack</span>
            <span className={twMerge(gradientText)}>Optimistic</span>
          </h1>
          <h2
          ...
          >
            Take control of your application's timing with TanStack Optimistic's{' '}
        ...
        <div className="px-4 sm:px-6 lg:px-8 mx-auto">
          <div className=" sm:text-center pb-16">
            ...
            <p className="mt-4 text-xl max-w-3xl mx-auto leading-7 opacity-60">
              TanStack Optimistic's API is highly modular and
        ...
        <div className="px-4 w-[500px] max-w-full mx-auto">
          ...
          >
            <span className="flex items-center gap-2 p-12 text-4xl text-rose-500 font-black uppercase">
              Optimistic <TbHeartHandshake /> You?
            </span>
            <div className="flex flex-col p-4 gap-4">
              <div>
                We're looking for a TanStack Optimistic OSS Partner to go above
                and beyond the call of sponsorship. Are you as invested in
                TanStack Optimistic as we are? Let's push the boundaries of
                Optimistic together!
              </div>
              <a
                href="mailto:partners@tanstack.com?subject=TanStack Optimistic Partnership"
        ...
        <div className="bg-white dark:bg-black">
          <iframe
            src={`https://stackblitz.com/github/${optimisticProject.repo}/tree/main/examples/react/useDebouncer?embed=1&theme=dark&preset=node&file=src/main.tsx`}
            title="tanstack/optimistic: useDebouncer"
