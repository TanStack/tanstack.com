...
export const rangerProject = {
  ...
  badge: undefined,
  bgStyle: 'bg-pink-500/40 dark:bg-pink-500/30',
  bgStyleAccent: 'bg-pink-500',
  bgStyleAccentHover: 'hover:bg-pink-500/30 dark:hover:bg-pink-500/40',
  bgStyleMuted: 'bg-pink-500/20',
