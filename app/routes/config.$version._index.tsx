    ...
    <>
      <div className="flex flex-col gap-20 md:gap-32">
        ...
        <div className="flex flex-col items-center gap-8 text-center px-4">
          ...
          <Link
            to="./docs/"
            className={`py-2 px-4 bg-gray-500 text-black rounded uppercase font-extrabold`}
            prefetch="intent"
          >
            Get Started
          </Link>
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <div>
            <Link
              to="./docs/"
              className={`inline-block py-2 px-4 bg-gray-500 rounded text-black uppercase font-extrabold`}
              prefetch="intent"
            >
              Get Started!
            </Link>
