...
export const storeProject = {
  ...
  badge: 'alpha',
  bgStyle: 'bg-twine-700/40 dark:bg-twine-700/30',
  bgStyleAccent: 'bg-twine-700',
  bgStyleAccentHover: 'hover:bg-twine-700/30 dark:hover:bg-twine-700/40',
  bgStyleMuted: 'bg-twine-700/20',
