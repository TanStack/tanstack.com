...
function FrameworkChip({ framework }: { framework: Framework }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${bgColor} text-white gap-1`}
  ...
  if (library.to) {
    return (
      <a
        ...
        } capitalize hover:underline focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors`}
