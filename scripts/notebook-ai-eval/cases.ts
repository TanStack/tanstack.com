import type { NotebookAiEvalCase } from './types'

export const notebookAiEvalCases = [
  {
    id: 'charts-basic-bar',
...
] satisfies ReadonlyArray<NotebookAiEvalCase>
