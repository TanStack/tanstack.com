    ...
    <div className="grid grid-cols-2 border-t border-shop-line mt-5.5">
      {specs.map((spec, i) => (
        <div
          key={spec.label}
          className={
            'flex justify-between gap-2.5 py-2.5 border-b border-shop-line text-shop-sm ' +
            (i % 2 === 0 ? 'pr-3 border-r border-shop-line' : 'pl-3')
          }
        >
          <b className="font-shop-mono font-normal text-shop-muted text-shop-xs tracking-[0.08em] uppercase">
            {spec.label}
          </b>
