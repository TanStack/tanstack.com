...
export const virtualProject = {
  ...
  badge: undefined,
  bgStyle: 'bg-purple-500/40 dark:bg-purple-500/30',
  bgStyleAccent: 'bg-purple-500',
  bgStyleAccentHover: 'hover:bg-purple-500/30 dark:hover:bg-purple-500/40',
  bgStyleMuted: 'bg-purple-500/20',
