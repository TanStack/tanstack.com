...
import { useCliCommand } from './useApplicationStarterUrl'
import { GeneratedPromptPreviewCard } from '~/components/application-starter/prompt-parts'
...
export type ApplicationStarterSummaryData = {
...
export function useApplicationStarterSummaryData(): ApplicationStarterSummaryData {
...
export function ApplicationStarterSummaryPanel({
  summary,
  className,
  compact = false,
  overlay,
}: {
  summary: ApplicationStarterSummaryData
  className?: string
  compact?: boolean
  overlay?: {
    description: string
