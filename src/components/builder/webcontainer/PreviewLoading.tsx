...
import { SETUP_STEP_LABELS, type SetupStep } from './useWebContainerStore'
...
export function PreviewLoading({ setupStep, error }: PreviewLoadingProps) {
  ...
  const stepLabel = SETUP_STEP_LABELS[setupStep] ?? setupStep
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          <ProgressStep
            ...
            isComplete={isStepComplete('booting', setupStep)}
          />
          <ProgressConnector
            isComplete={isStepComplete('booting', setupStep)}
          />
          <ProgressStep
            ...
            isComplete={isStepComplete('mounting', setupStep)}
          />
          <ProgressConnector
            isComplete={isStepComplete('mounting', setupStep)}
          />
          <ProgressStep
            ...
            isComplete={isStepComplete('installing', setupStep)}
          />
          <ProgressConnector
            isComplete={isStepComplete('installing', setupStep)}
          />
          <ProgressStep
            ...
            isComplete={isStepComplete('starting', setupStep)}
          />
        </div>
      </div>
    </div>
