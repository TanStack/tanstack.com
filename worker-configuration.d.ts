/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9322071d93a08c931bd2c2b8390b190e)
// Runtime types generated with workerd@1.20260617.1 2026-06-19 nodejs_compat
interface __BaseEnv_Env {
	GITHUB_CONTENT_CACHE: R2Bucket;
	FORGE_RUNTIME: R2Bucket;
	AI: Ai;
	ASSETS: Fetcher;
	SITE_URL: "https://tanstack.com";
	PREVIEW_HOSTNAME: "forge.tanstack.com";
	SANDBOX_TRANSPORT: "http";
	FORGE_SESSIONS: DurableObjectNamespace<import("./src/server").ForgeSessionDurableObject>;
	Sandbox: DurableObjectNamespace /* Sandbox */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ForgeSessionDurableObject" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "PREVIEW_HOSTNAME" | "SANDBOX_TRANSPORT">> {}
}
