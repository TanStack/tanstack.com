...
export const Route = createFileRoute("/api/application-starter/download")({
  server: {
    handlers: {
        ...
        try {
          ...
          if (
            ...
            return applicationStarterErrorResponse(
              "Invalid applicationStarter download request",
              400,
          ...
          for (const [key, value] of url.searchParams.entries()) {
            if (key.includes(".") && value) {
              ...
              if (
                ...
                return applicationStarterErrorResponse(
                  "Invalid applicationStarter download options",
                  400,
                  requestGuard.rateLimit,
                );
              }
          ...
          return applicationStarterInternalErrorResponse("Failed to generate ZIP");
        }
      },
    },
  },
